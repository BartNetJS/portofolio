...
![Diagram comparing a classical bit (either 0 or 1) with a quantum qubit in superposition](./images/extracted/bits-vs-qubits.png)
...
![Diagram showing four search spots with a single classical token versus multiple ghosted quantum tokens occupying every spot at once](./images/extracted/superposition-in-action.png)
